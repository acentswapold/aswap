...
## 1. deploy `acentswapRouter`

deploy a `acentswapRouter` contract for each supported blockchain

## 2. deploy `acentswapERC20`

deploy a `acentswapERC20` contract for each token on each blockchain
...
please ref. [config-example.toml](https://github.com/acentswap/aswap/blob/main/params/config-example.toml)
...
please ref. [server rpc api](https://github.com/acentswap/aswap/blob/main/rpc/README.md)
